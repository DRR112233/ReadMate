# 心动书架 (ReadMate) - 恋人共读 AI 伴读系统

## 📖 项目简介
心动书架是一款专为情侣或渴望情感陪伴的用户设计的 AI 伴读应用。它不仅仅是一个电子书阅读器，更是一个拥有“灵魂”的虚拟恋人。通过先进的 AI 技术，应用内的虚拟恋人会陪你一起阅读，在字里行间留下情感批注，与你讨论书中的细节，并记录下你们共同阅读的点点滴滴。

本项目作为毕业设计作品，旨在探索 AI 在情感陪伴与数字化阅读领域的深度融合。

## ✨ 核心功能
- **AI 恋人伴读**：支持自定义人设（傲娇、温柔、霸道等），TA 会根据你阅读的内容实时产生情感共鸣和批注。
- **全格式支持**：完美支持 EPUB 和 PDF 格式书籍导入。
